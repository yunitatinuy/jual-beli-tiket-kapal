...
<main>
    <div class="container my-10 ">
        <div
            class="container justify-content-center rounded-lg bg-gradient-to-tr from-[#ffebe1] to-[#DEC3B4] mb-6 mx-auto my-20">
        ...
        <div class="flex mb-4">
            ...
            <div class="w-full md:w-1/2 md:ml-2 px-3 py-2 rounded-lg bg-[#e5cabb] md:mt-0">
                Pesanan
                <div class="px-2 py-2 mt-2 rounded-lg bg-gradient-to-tr from-[#ffebe1] to-[#efd5c8]"> 1 Tiket Dewasa
                </div>
            </div>
        </div>
        ...
        <div class="flex mb-4">
            ...
            <div class="w-full md:w-1/2 md:ml-2 px-3 py-2 rounded-lg bg-[#e5cabb] md:mt-0">
                $ Total Harga
                <div class="px-2 py-2 mt-2 rounded-lg bg-gradient-to-tr from-[#ffebe1] to-[#efd5c8]"> Rp 540.000
                </div>
            </div>
        </div>
