...
@section('container')
    <section class="">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            @endif
            <div
                class="w-full bg-gradient-to-b from-[#E970C0] to-[#CA1A5A]  rounded-lg shadow light:border md:mt-0 sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6">
                    ...
                    <form class="space-y-4 md:space-y-6" action="/login" method="post">
                        ...
                        <button type="submit"
                            class="w-full text-dark bg-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Login</button>
                        <p class="text-sm font-light text-black light:text-gray-400">
                            Belum punya akun? <a href="/registrasi"
                                class="font-medium text-primary-600 hover:underline ">Registrasi disini</a>
                        </p>
                    </form>
                </div>
            </div>
