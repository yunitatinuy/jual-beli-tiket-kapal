            ...
            <form wire:submit="store">
                ...
                <div class="flex p-6">
                    <div class="relative z-0 w-full group">
                        <input type="text" name="namapelabuhan" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " wire:model="namapelabuhan" required />
                ...
                <table class="min-w-full text-center text-sm text-surface">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-secondary-200 bg-secondary-50 text-neutral-800">
                            ...
                            <td class="whitespace-nowrap px-6 py-4">{{$value->idpelabuhan}}</td>
                            <td class="whitespace-nowrap px-6 py-4">{{$value->namapelabuhan}}</td>
                            <td class="whitespace-nowrap px-6 py-4">{{$value->namakapal}}</td>
                            <td class="whitespace-nowrap px-6 py-4">

                                <!-- Edit -->
                                <button wire:click="edit({{$value->idpelabuhan}})" class="flex-none p-2.5 bg-sky-500 rounded-xl hover:rounded-3xl hover:bg-sky-600 transition-all duration-300 text-white" type="button">
                                ...
                                <!-- Delete -->
                                <button onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?') || event.stopImmediatePropagation()" wire:click="delete({{$value->idpelabuhan}})" class="flex-none p-2.5 bg-red-500 rounded-xl hover:rounded-3xl hover:bg-red-600 transition-all duration-300 text-white">
