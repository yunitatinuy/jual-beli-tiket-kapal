                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-secondary-200 bg-secondary-50 text-neutral-800">
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                ...
                                <!-- Edit -->
                                <button wire:click="edit({{$value->idkapal}})" class="flex-none p-2.5 bg-sky-500 rounded-xl hover:rounded-3xl hover:bg-sky-600 transition-all duration-300 text-white" type="button">
                                ...
                                <!-- Delete -->
                                <button onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?') || event.stopImmediatePropagation()" wire:click="delete({{$value->idkapal}})" class="flex-none p-2.5 bg-red-500 rounded-xl hover:rounded-3xl hover:bg-red-600 transition-all duration-300 text-white">
