<div>
    ...
    <div class="ms-10 mt-10 me-10 flex flex-col flex-grow">
        ...
        <span class="flex items-center p-2 text-gray-900 rounded-lg">
            <img src="/img/icons/shopping-cart.png" class="flex-shrink-0 w-8 h-8 text-gray-500" aria-hidden="true" fill="currentColor">
        ...
        <div class="container font-inter">
            <div class="flex flex-wrap">
                ...
                <div class="mt-7">
                    <a href="/admin/tambahtiket" class="flex items-center p-2 text-gray-900 border-2 rounded-lg bg-slate-100 hover:bg-sky-500 hover:text-white transition duration-700 group">
                            ...
                            <table class="min-w-full text-center text-sm text-surface">
                                <thead class="border-b border-neutral-200 font-medium">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-4">ID Rute</th>
                                        <th scope="col" class="px-6 py-4">ID Pengguna</th>
                                        <th scope="col" class="px-6 py-4">ID Tiket</th>
                                        <th scope="col" class="px-6 py-4">Tanggal</th>
                                        <th scope="col" class="px-6 py-4">Waktu</th>
                                        <th scope="col" class="px-6 py-4">Total Transaksi</th>
                                ...
                                <tbody>
                                    <tr class="border-b border-secondary-200 bg-secondary-100 text-neutral-800">
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4">1101</td>
                                        <td class="whitespace-nowrap px-6 py-4">0001</td>
                                        <td class="whitespace-nowrap px-6 py-4">02-05-2024</td>
                                        <td class="whitespace-nowrap px-6 py-4">13:30</td>
                                        <td class="whitespace-nowrap px-6 py-4">600.000</td>
