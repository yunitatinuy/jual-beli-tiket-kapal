...
<div class="ms-10 mt-10 me-10 flex flex-col flex-grow">
    ...
    <div class="container font-inter">
        <div class="flex flex-wrap">
            ...
            <div class="mt-7">
                <a href="/admin/tambahpelabuhan" class="flex items-center p-2 text-gray-900 border-2 rounded-lg bg-slate-100 hover:bg-sky-500 hover:text-white  transition duration-700 group">
                        ...
                        <table class="min-w-full text-center text-sm text-surface">
                            <thead class="border-b border-neutral-200 font-medium">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-4">Pelabuhan</th>
                            ...
                            <tbody>
                                <tr class="border-b border-secondary-200 bg-secondary-100 text-neutral-800">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">0101</td>
                                    <td class="whitespace-nowrap px-6 py-4">Batam Fast Ferry</td>
                                    <td class="whitespace-nowrap px-6 py-4">Batam Center</td>
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex p-6">
                <div class="relative z-0 w-full group">
                    ...
                    <label for="floating_email" class="peer-focus:font-medium absolute font-inter text-sm text-gray-600 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4    rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Kode Pelabuhan</label>
                </div>
            </div>
