...
<div class="container">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full mt-[82px] px-3 py-4 overflow-y-auto bg-gray-50">
...
<div class="ms-72 mt-10">
    ...
    <div class="container font-inter">
        <div class="flex flex-wrap">
            ...
            <div class="mt-7">
                <a href="/admin/tambahrute" class="flex items-center p-2 text-gray-900 border-2 rounded-lg bg-slate-100 hover:bg-sky-500 hover:text-white transition duration-700 group">
                        ...
                        <table class="min-w-full text-center text-sm text-surface">
                            ...
                            <tbody>
                                <tr class="border-b border-secondary-200 bg-secondary-100 text-neutral-800">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">HarborFront Center (Singapore)</td>
                                    <td class="whitespace-nowrap px-6 py-4">25 April 2024</td>
                                    <td class="whitespace-nowrap px-6 py-4">08:00</td>
