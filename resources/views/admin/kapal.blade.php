    ...
    <div class="container font-inter">
        ...
        <div class="flex flex-col mt-5">
            <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                        ...
                        <table class="min-w-full text-center text-sm text-surface">
                            ...
                            @forelse ($kapals as $kapal)
                                <tr class="border-b border-secondary-200 bg-secondary-100 text-neutral-800">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">{{$kapal->idkapal}}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{$kapal->namakapal}}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{$kapal->kelas}}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{$kapal->jumlahkursi}}</td>
                                    <td class="whitespace-nowrap px-6 py-4">

                                        <!-- Edit -->
                                        <button data-modal-target="large-modal" data-modal-toggle="large-modal" class="flex-none p-2.5 bg-sky-500 rounded-xl hover:rounded-3xl hover:bg-sky-600 transition-all duration-300 text-white" type="button">
                        ...
                        <div class="relative bg-white rounded-lg shadow">
                            ...
                            <div class="flex p-6">
                                <div class="relative z-0 w-full group">
                                    ...
                                    <label for="floating_email" class="peer-focus:font-medium absolute font-inter text-sm text-gray-600 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4    rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Kode Kapal</label>
                                </div>
                            </div>
                ...
                <div id="popup-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full animate-fade">
