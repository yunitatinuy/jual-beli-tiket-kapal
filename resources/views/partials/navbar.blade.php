    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
        ...
        <div class="sidebar">
            <ul class="flex flex-row font-marko">
                <li><a href="/informasi"class="px-2 hover:text-slate-50">Informasi</a></li>
                <li><a href="/transaksi"class="px-2 hover:text-slate-50">Transaksi</a></li>
                <li><a href="/profil"class="px-2 hover:text-slate-50">Profil</a></li>
            </ul>
        </div>
