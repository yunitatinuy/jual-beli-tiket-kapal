            ...
            <div class="p-6 space-y-4 md:space-y-6">
                ...
                <form class="space-y-4 md:space-y-6" action="/login" method="post">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" class="bg-gray-50 border text-gray-900 sm:text-sm rounded-lg focus:ring-[#c99a7c] focus:ring-4 focus:border-slate-50 focus:bg-slate-300 block w-full p-2.5 @error('email') is-invalid @enderror">
                        @error('email')
                        <div class="invalid-feedback font-semibold text-xs">
                            {{ $message }}
                        </div>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="password" name="password" id="password" class="bg-gray-50 border text-gray-900 sm:text-sm rounded-lg focus:ring-[#c99a7c] focus:ring-4 focus:border-slate-50 focus:bg-slate-300 block w-full p-2.5 @error('password') is-invalid @enderror">
                        @error('password')
                        <div class="invalid-feedback font-semibold text-xs">
                            {{ $message }}
                        </div>
