...
<div class="flex items-center justify-center min-h-screen p-5 min-w-screen">
    <div class="w-full p-8 text-center text-gray-800 bg-slate-100 shadow-xl hover:scale-105 transition duration-200 hover:ease-out lg:max-w-3xl rounded-3xl lg:p-12">
        <h3 class="text-3xl">Terima Kasih sudah registrasi di Anang Ferry!</h3>
        <div class="flex justify-center">
            <svg class="w-1/4 h-1/4 p-4" viewBox="0 0 50 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p class="font-inter p-3">Kami sangat senang Anda disini. Ayo verifikasi Email Anda: {{ auth()->user()->email }}</p>
        <button class="px-2 py-2 font-inter text-white bg-blue-600 rounded" href="{{ route('verification.send') }}" style="cursor: pointer" onclick="event.preventDefault(); document.getElementById('verify-form').submit()">
